    ...
    return (
      <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-sm p-8">
        <div className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-center text-neutral-800 dark:text-neutral-100 mb-2">معلومات المشارك</h2>
        ...
        <form onSubmit={handleStartQuestions} className="space-y-6">
          <div>
            <label className="block text-lg font-semibold text-neutral-800 dark:text-neutral-100 mb-3">
              الاسم الثلاثي *
            </label>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <input
                ...
                className="w-full px-4 py-3 border-2 border-neutral-200 dark:border-neutral-600 dark:bg-neutral-700 dark:text-neutral-100 rounded-lg focus:border-primary focus:outline-none"
                required
              />
              <input
                type="text"
  ...
  if (step === 'questions') {
    return (
      <div className="space-y-6">
        ...
        {showAllQuestions && (
          <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-sm p-6">
            <h3 className="text-xl font-bold text-neutral-800 dark:text-neutral-100 mb-4">جميع الأسئلة</h3>
            <div className="space-y-4 max-h-96 overflow-y-auto">
              {questions.map((q, idx) => (
                <div key={q.id} className="p-4 border-2 border-neutral-200 dark:border-neutral-600 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-neutral-800 dark:text-neutral-100 font-medium">{q.question_text}</p>
                      {answers[q.id] && (
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-sm p-8">
                ...
                <button
                  ...
                  className={`w-full text-right px-6 py-4 rounded-lg border-2 transition-all ${
                    answers[currentQuestion.id] === option
                      ...
                      : 'border-neutral-200 dark:border-neutral-600 hover:border-primary/50'
                  }`}
                >
                  {option}
                </button>
              ...
              <button
                ...
                className={`px-6 py-4 rounded-lg border-2 transition-all ${
                  answers[currentQuestion.id] === 'true'
                    ? 'border-green-600 bg-green-50 dark:bg-green-900/20 font-semibold'
              ...
              <button
                ...
                className={`px-6 py-4 rounded-lg border-2 transition-all ${
                  answers[currentQuestion.id] === 'false'
                    ? 'border-red-600 bg-red-50 dark:bg-red-900/20 font-semibold'
          ...
          <div className="mb-8">
            <label className="block text-lg font-semibold text-neutral-800 dark:text-neutral-100 mb-3">
              الدليل من المصدر * <span className="text-sm text-neutral-600 dark:text-neutral-400">(مطلوب)</span>
            </label>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border-2 border-amber-300 dark:border-amber-600 rounded-lg focus:border-amber-500 focus:outline-none bg-white dark:bg-neutral-700 dark:text-neutral-100"
                    required
                  />
                </div>
                <div>
          ...
          <div className="flex items-center gap-4">
            {currentQuestionIndex > 0 && (
              <button
                ...
                className="px-6 py-3 border-2 border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-300 font-semibold rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-all"
              >
                السابق
              </button>
            )}
    ...
    return (
      <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-sm p-8 text-center">
        <div className={`w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 ${
          allCorrect ? 'bg-green-100 dark:bg-green-900/20' : someCorrect ? 'bg-amber-100 dark:bg-amber-900/20' : 'bg-blue-100 dark:bg-blue-900/20'
        }`}>
        ...
        <h2 className={`text-3xl font-bold mb-4 ${
          allCorrect ? 'text-green-700 dark:text-green-400' : someCorrect ? 'text-amber-700 dark:text-amber-400' : 'text-blue-700 dark:text-blue-400'
        }`}>
