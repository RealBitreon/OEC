...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary-dark text-white pt-12 md:pt-16 pb-6 md:pb-8 mt-auto">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
              <div className="w-10 h-10 md:w-12 md:h-12 bg-secondary rounded-xl flex items-center justify-center">
                <span className="text-xl md:text-2xl font-bold text-primary-dark">م</span>
              </div>
              <div>
                <div className="text-base md:text-lg font-bold">{config.site.title}</div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-base md:text-lg font-bold mb-3 md:mb-4">روابط سريعة</h3>
          ...
          {/* Resources */}
          <div>
            <h3 className="text-base md:text-lg font-bold mb-3 md:mb-4">المساعدة</h3>
            <ul className="space-y-2 md:space-y-3">
              <li>
